package com.blackink.app.presentation.screens.welcome
...
fun WelcomeScreen(onGetStarted: () -> Unit, onHaveAccount: () -> Unit) {
    ...
    ScreenScaffold {
        Column(Modifier.fillMaxWidth().weight(1f).verticalScroll(rememberScrollState()).padding(24.dp)) {
            ...
            Text(
                "BlackInk tracks every device you buy, every dollar you spend, and exactly what you earn when it sells.",
